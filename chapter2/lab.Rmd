...
To generated a matrix of scatterplots, we can use the  [`pairs()`](http://bit.ly/R_pairs) 
...
The [`identify()`](http://bit.ly/R_identify) function can be used to identify specific points on a plot. In an interaction session in R-Studio, [`identify()`](http://bit.ly/R_identify) allows you to click on specific points and labels them on screen for convenient identification.
